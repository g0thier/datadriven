...
/**
 * Renders Design Thinking step 4 (individual idea generation).
 *
 ...
 * <Step4 step={step} sessionTitle={sessionTitle} collaboration={collaboration} session={session} />;
 */
function Step4({ step, sessionTitle, collaboration, session }) {
  ...
  const problemStatement = String(collaboration?.problemStatement || "").trim() || "La problématique sera visible ici dès qu'elle est définie à l'étape 3.";
