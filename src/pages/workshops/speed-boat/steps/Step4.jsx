...
/**
 * @module workshops/speed-boat/steps/Step4
 * @description Speed Boat step 4 screen for collaborative clustering and positioning of brake notes.
...
/**
 * Renders Speed Boat step 4 (collective board organization for brakes).
 *
...
export default function Step4({ step, sessionTitle, collaboration }) {
  ...
  const setBrakeNotePositionAction = collaboration?.actions?.setBrakeNotePosition;
  ...
  const handleMoveEnd = useCallback(
    (noteId, position) => {
      ...
      setBrakeNotePositionAction?.(noteId, position);
    },
    [setBrakeNotePositionAction]
  );
      ...
      <div className="bg-white rounded-2xl shadow-md p-4">
        <div className="flex items-center justify-between mb-3">
          <p className="text-sm text-gray-600">
            {notes.length} freins • Glissez-déposez pour organiser
          </p>
