/**
 * @module workshops/speed-boat/steps/Step6
 * @description Speed Boat step 6 screen for collaborative clustering and positioning of lever notes.
...
function useDragNotes({ canvasRef, getScale, onMove, onMoveEnd, onDragStart }) {
...
/**
 * Renders Speed Boat step 6 (collective board organization for levers).
 *
...
export default function Step6({ step, sessionTitle, collaboration }) {
  ...
  const setLeverNotePositionAction = collaboration?.actions?.setLeverNotePosition;
  ...
  const handleMoveEnd = useCallback(
    (noteId, position) => {
      ...
      setLeverNotePositionAction?.(noteId, position);
    },
    [setLeverNotePositionAction]
  );
      ...
      <div className="bg-white rounded-2xl shadow-md p-4">
        <div className="flex items-center justify-between mb-3">
          <p className="text-sm text-gray-600">
            {notes.length} leviers • Glissez-déposez pour organiser
          </p>
          ...
          <div className="w-full overflow-auto rounded-xl border border-slate-200">
            ...
            >
              ...
              {notesWithDisplayPosition.map((note) => (
                ...
                >
                  <div
                    className="relative bg-blue-100 rounded-lg shadow-md p-4"
