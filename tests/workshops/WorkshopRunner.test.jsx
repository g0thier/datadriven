...
vi.mock("../../src/workshops/useStepTimeline.js", () => ({
  useStepTimeline: () => timelineState,
}));

vi.mock("../../src/workshops/paper-brain/usePaperBrainCollaboration.js", () => ({
  usePaperBrainCollaboration: () => ({ notes: [] }),
}));

vi.mock("../../src/workshops/StepTime.jsx", () => ({ default: () => <div>STEP_TIME</div> }));
vi.mock("../../src/workshops/WorkshopWaitingPage.jsx", () => ({ default: () => <div>WAITING_PAGE</div> }));
vi.mock("../../src/workshops/WorkshopSummaryPage.jsx", () => ({ default: () => <div>SUMMARY_PAGE</div> }));
...
import WorkshopRunner from "../../src/workshops/WorkshopRunner.jsx";
